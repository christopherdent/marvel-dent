        ...
        return (  
          <Col sm={6} md={4} lg={4}>
           <Tile 
            key = {comic.id}      
            title = {comic.title}           
            image = { comic.thumbnail.path !== 'http://i.annihil.us/u/prod/marvel/i/mg/b/40/image_not_available' ? comic.thumbnail.path + "." + comic.thumbnail.extension : 'https://i5.walmartimages.com/asr/7c39143f-6d73-4f81-8c4e-9418804f47f2_1.0a075aa7294b8a62fe99895a82618550.jpeg' }           
